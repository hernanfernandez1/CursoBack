import { saveProduct, getAllProducts, updateProductById, deleteProductById } from "../services/products.services.js";
...
export const updateProductByIdController = async (ctx, next) => {
  ...
  const data = await updateProductById(id, title, description, code, photo, value, stock);
  ctx.body = {
    status: "success",
    data: data,
  };
