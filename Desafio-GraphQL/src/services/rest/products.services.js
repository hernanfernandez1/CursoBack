...
export async function updateProductById(id, title, description, code, photo, value, stock) {
  const prod = await productsRepository.updateProductById(id, title, description, code, photo, value, stock);
  return prod;
}
