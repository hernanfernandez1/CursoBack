...
const router = Router();
import { getProductsInCart, createCart, addProductsToCart, deleteCartById, deleteProductInCartById, finishOrder } from "../controllers/cart.controller.js";
...
router.post("/:id/productos", isLoggedIn, body("id").not().isEmpty().isInt({ min: 1 }), addProductsToCart);
